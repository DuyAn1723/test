...
private:
    int callTime; //th?i gian g?i
    double callRate; //ti?n g?i(1000d/h)
    int dataUsage;//internet s? d?ng (MB)
    double dataRate;//ti?n inrternet(200d/MB)
...
int main() {
    ...
    // t?o thông tin
    BasicContract* contract1 = new BasicContract("Cong", "123456789", "97 Man Thien", 100, 1000, 500, 200);
    DataFreeContract* contract2 = new DataFreeContract("Vuong", "987654321", "97 Man Thien", 200, 1000, 800, 200, 500);
    DataFixContract* contract3 = new DataFixContract("Thanh", "456789123", "97 Man Thien", 50, 1000, 180, 200, 1000000);
